...
public class FileChooser extends ListActivity {
    public static final int REQUEST_ID_FOR_RW_EXTERNAL_STORAGE_PERMISSION = 0;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
            ...
            Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED)
        {
            ...
            requestPermissions(new String[]{
                ...
                REQUEST_ID_FOR_RW_EXTERNAL_STORAGE_PERMISSION);
        }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case REQUEST_ID_FOR_RW_EXTERNAL_STORAGE_PERMISSION: {
                // If request is cancelled, the result arrays are empty.
                if (grantResults.length > 0
                    && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    // permission was granted, yay! Refresh directory listing
                    getDir(pathHome.exists()? pathHome.getPath(): strStartPath);
                } else {
